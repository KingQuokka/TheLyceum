...
int main(int argc, char* argv[])
{
    ...
    while(fin >> x)
    {
        ...
        polygon.setOrigin(xSpeed, ySpeed);
        ...
        sf::CircleShape circle(polyRadius, polyPoints); // cirlce with given radius 
        circle.setFillColor(sf::Color::Green);                 // circle color 
        circle.setPosition(x, y);  // cirlce starting position
        float circleMoveSpeedX = xSpeed;            // x axis move on bounce 
        float circleMoveSpeedY = ySpeed;            // y axis move on bounce  
        **/
